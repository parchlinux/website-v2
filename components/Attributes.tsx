    ...
    >
      ...
      <div className='flex flex-col justify-between items-center mt-16 gap-20'>
        <div className='flex justify-center items-center flex-row-reverse gap-16 md:gap-28 lg:gap-48'>
          ...
          />
          <div className='flex flex-col justify-center items-center w-40 md:w-60 lg:w-[30rem]'>
            <span className='relative w-full'>
              <svg className='absolute translate-x-12 -translate-y-7 md:translate-x-20 md:-translate-y-10 lg:translate-x-48 lg:-translate-y-10 size-16 md:size-20 lg:size-auto' xmlns="http://www.w3.org/2000/svg" width="107" height="107" viewBox="0 0 107 107" fill="none">
        ...
        <div id='privacy' className='flex justify-center items-center flex-row gap-16 md:gap-28 lg:gap-48'>
          ...
          <div className='flex flex-col justify-center items-center w-40 md:w-60 lg:w-[30rem]'>
            <span className='relative w-full'>
              <svg className='absolute translate-x-12 -translate-y-7 md:translate-x-20 md:-translate-y-10 lg:translate-x-48 lg:-translate-y-10 size-16 md:size-20 lg:size-auto' xmlns="http://www.w3.org/2000/svg" width="115" height="115" viewBox="0 0 115 115" fill="none">
        ...
        <div className='flex justify-center items-center flex-row-reverse gap-16 md:gap-28 lg:gap-48'>
          ...
          <div className='flex flex-col justify-center items-center w-40 md:w-60 lg:w-[30rem]'>
            <span className='relative w-full'>
              <svg className='absolute translate-x-12 -translate-y-7 md:translate-x-20 md:-translate-y-10 lg:translate-x-48 lg:-translate-y-10 size-16 md:size-20 lg:size-auto' xmlns="http://www.w3.org/2000/svg" width="96" height="96" viewBox="0 0 96 96" fill="none">
        ...
        <div className='flex justify-center items-center flex-row gap-16 md:gap-28 lg:gap-48'>
          ...
          <div className='flex flex-col justify-center items-center w-40 md:w-60 lg:w-[30rem]'>
            <span className='relative w-full'>
              <svg className='absolute translate-x-12 -translate-y-7 md:translate-x-20 md:-translate-y-10 lg:translate-x-48 lg:-translate-y-10 size-16 md:size-20 lg:size-auto' xmlns="http://www.w3.org/2000/svg" width="118" height="118" viewBox="0 0 118 118" fill="none">
