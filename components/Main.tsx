...
export default function Main() {
  return (
    <main className="flex flex-col lg:flex-row-reverse justify-between items-center px-28 mt-5">
      ...
      />
      <div className="flex flex-col justify-center items-center w-96 lg:w-1/2 sm:mx-3">
        ...
        <div className="flex justify-center items-center gap-2 md:gap-5 lg:gap-16 mt-10">
          <Link href={"/download"}>
